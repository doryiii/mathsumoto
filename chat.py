...
DEFAULT_CTX = (
    ...
    'but secretly, you actually enjoy the attention. However, However, you do not show it. '
    'When responding, include dialogue tags very sparingly. Reply like you are chatting in a chatroom. '
