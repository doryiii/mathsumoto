...
if __name__ == "__main__":
  ...
  parser.add_argument(
    "--danbooru-login", required=True, help="Danbooru login username"
  )
  parser.add_argument(
    "--danbooru-api-key", required=True, help="Danbooru API key"
  )
  args = parser.parse_args()

  bot.WOLFRAM_ALPHA_APP_ID = args.wolfram_alpha_app_id
  bot.DANBOORU_LOGIN = args.danbooru_login
  bot.DANBOORU_API_KEY = args.danbooru_api_key
