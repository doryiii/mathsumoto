...
class AoiCog(commands.Cog):
  ...
  @commands.command()
  async def aoi(self, ctx, *, message: str = None):
  ...
  @commands.command()
  async def aoiyell(self, ctx, *, message: str = None):
    message = message if message is not None else ""
    await ctx.send("", files=[self.scribus("aoiyell", message, "aoi.png")])

  @commands.command()
  async def aoitsun(self, ctx, *, message: str = None):
    message = message if message is not None else ""
    await ctx.send("", files=[self.scribus("aoitsun", message, "aoi.png")])

  @commands.command()
  async def aoisay(self, ctx, *, message: str = None):
    message = message if message is not None else "Nya."
    await ctx.send("", files=[self.scribus("aoisay", message, "aoi.png")])

  @commands.command()
  async def aoithink(self, ctx, *, message: str = None):
    message = message if message is not None else "Nya..."
    await ctx.send("", files=[self.scribus("aoithink", message, "aoi.png")])

  @commands.command()
  async def aoiwave(self, ctx, *, message: str = None):
    message = message if message is not None else "Nya!"
    await ctx.send("", files=[self.scribus("aoiwave", message, "aoi.png")])

  @commands.command()
  async def aoiexcite(self, ctx, *, message: str = None):
    message = message if message is not None else "Nya~"
    await ctx.send("", files=[self.scribus("aoiexcite", message, "aoi.png")])

  @commands.command()
  async def aoiwhisper(self, ctx, *, message: str = None):
    message = message if message is not None else "You cute!"
    await ctx.send("", files=[self.scribus("aoiwhisper", message, "aoi.png")])

  @commands.command()
  async def aoieat(self, ctx, *, message: str = None):
    message = message if message is not None else "Mico!"
    await ctx.send("", files=[self.scribus("aoieat", message, "aoi.png")])

  @commands.command()
  async def aoiheart(self, ctx, *, message: str = None):
    message = message if message is not None else "Mico"
